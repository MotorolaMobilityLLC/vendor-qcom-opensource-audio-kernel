...
SND_SOC_DAILINK_DEFS(pri_mi2s_rx_tfa98xx,
	DAILINK_COMP_ARRAY(COMP_CPU("snd-soc-dummy-dai")),
       DAILINK_COMP_ARRAY(COMP_CODEC("tfa98xx.23-0034", "tfa98xx-aif-34"),
                          COMP_CODEC("tfa98xx.23-0035", "tfa98xx-aif-35")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("snd-soc-dummy")));
...
SND_SOC_DAILINK_DEFS(sen_mi2s_rx_tfa98xx,
        DAILINK_COMP_ARRAY(COMP_CPU("snd-soc-dummy-dai")),
       DAILINK_COMP_ARRAY(COMP_CODEC("tfa98xx.11-0034", "tfa98xx-aif-34"),
                          COMP_CODEC("tfa98xx.11-0035", "tfa98xx-aif-35")),
        DAILINK_COMP_ARRAY(COMP_PLATFORM("snd-soc-dummy")));

SND_SOC_DAILINK_DEFS(sen_mi2s_tx_tfa98xx,
        DAILINK_COMP_ARRAY(COMP_CPU("snd-soc-dummy-dai")),
       DAILINK_COMP_ARRAY(COMP_CODEC("tfa98xx.11-0034", "tfa98xx-aif-34"),
                          COMP_CODEC("tfa98xx.11-0035", "tfa98xx-aif-35")),
        DAILINK_COMP_ARRAY(COMP_PLATFORM("snd-soc-dummy")));
